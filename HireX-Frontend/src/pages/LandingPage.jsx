        ...
        <div className="min-h-screen bg-white font-sans text-gray-900">
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-8 text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center max-w-5xl mx-auto">
                    ...
                    <div className="bg-gray-200 rounded-xl p-8 shadow-sm flex flex-col items-center text-center h-full">
                        <h3 className="text-lg font-bold mb-3">For HR Managers</h3>
                    ...
                    {/* Candidates Card */}
                    <div className="bg-gray-200 rounded-xl p-8 shadow-sm flex flex-col items-center text-center h-full">
                        <h3 className="text-lg font-bold mb-3">For Candidates</h3>
                        <p className="text-sm text-gray-600 mb-6 flex-grow">
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="text-center mb-12">
                    <h2 className="text-xl font-bold mb-2">Intelligent Automation For Modern Hiring</h2>
            ...
            <section className="bg-gray-200 py-20 text-center mb-16">
                <h2 className="text-xl font-bold mb-12">Start Your Next Career Move</h2>
