        ...
        <div className="min-h-screen bg-gray-50 font-sans text-gray-900 flex flex-col">
            ...
            <main className="flex-1 max-w-7xl mx-auto w-full p-8">
                ...
                <div className="mb-10">
                    ...
                    <p className="text-gray-500 mt-2">Monitor platform activity and system health.</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col justify-between h-40">
                        ...
                        <div>
                            <p className="text-gray-500 text-sm mb-1">Active Job Posts</p>
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col justify-between h-40">
                        ...
                        <div>
                            <p className="text-gray-500 text-sm mb-1">Applications processed</p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 h-full">
                        <h2 className="text-xl font-bold text-gray-900 mb-8 text-center">User Management</h2>
                        
                        <div className="space-y-6">
                            <div className="bg-gray-50 p-6 rounded-xl text-center">
                                <p className="text-gray-600 font-medium mb-4">Add / remove roles</p>
                                <button className="bg-[#84cc16] hover:bg-[#65a30d] text-white font-bold py-2.5 px-6 rounded-lg shadow-sm transition-colors w-full max-w-[180px]">
                                    Manage roles
                                </button>
                            </div>

                            <div className="bg-gray-50 p-6 rounded-xl text-center">
                                <p className="text-gray-600 font-medium mb-4">Manage Users Info</p>
                                <button className="bg-[#84cc16] hover:bg-[#65a30d] text-white font-bold py-2.5 px-6 rounded-lg shadow-sm transition-colors w-full max-w-[180px]">
                                    Edit Users
                                </button>
                            </div>
                    ...
                    {/* System Settings */}
                    <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 h-full">
                        <h2 className="text-xl font-bold text-gray-900 mb-8 text-center">System Settings</h2>
                        
                        <div className="bg-gray-50 p-6 rounded-xl text-center h-[calc(100%-4rem)] flex flex-col justify-center items-center">
                            <p className="text-gray-600 font-medium mb-4">Update Company Info</p>
                            <button className="bg-[#84cc16] hover:bg-[#65a30d] text-white font-bold py-2.5 px-8 rounded-lg shadow-sm transition-colors">
                                Edit Info
                            </button>
                        </div>
                    </div>
                    ...
                    {/* System Analytics */}
                    <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 h-full">
                        <h2 className="text-xl font-bold text-gray-900 mb-8 text-center">System Analytics</h2>
