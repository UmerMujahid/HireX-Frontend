        ...
        <div className="min-h-screen bg-gray-50 flex font-sans text-gray-900">
            ...
            <aside className="w-64 bg-white border-r border-gray-200 flex flex-col fixed h-full z-10">
                ...
                <nav className="flex-1 px-4 space-y-2 mt-4">
                    <button className="flex items-center gap-3 w-full px-4 py-3 text-gray-900 bg-gray-100 rounded-lg font-medium transition-colors">
                        <Home size={20} />
                        Home
                    </button>
            ...
            <div className="flex-1 ml-64 flex flex-col min-h-screen">
                <main className="flex-1 p-8">
                    ...
                    <header className="flex justify-between items-start mb-8">
                        ...
                        <div>
                            <button className="bg-[#10b981] text-white px-4 py-2 rounded-lg font-bold flex items-center gap-2 hover:bg-[#059669] transition-colors shadow-sm">
                                <Plus size={18} />
                                Post New Job
                            </button>
                        </div>
                                            ...
                                            {[
                                                ...
                                                <tr key={index}>
                                                    ...
                                                    <td className="py-4 text-right">
                                                        <button className="bg-[#10b981] text-white text-xs font-bold px-3 py-1.5 rounded hover:bg-[#059669] transition-colors">
                                                            View Applications
                                                        </button>
                                                    </td>
                                                </tr>
